        ...
        if (isset($_POST['submit'])) {
            ...
            foreach ($logs as $Log) {
                $eventos[] = [
                    ...
                    '<button type="button" class="btn btn-'.$Log->getSeverity()->style.'" data-bs-toggle="modal" data-bs-target="#modal-log" data-log_id="'.$Log->id.'" title="Ver detalle del evento"><span class="fas fa-search" aria-hidden="true"></span></button>',
                ];
            }
            $this->set([
                'eventos' => $eventos
