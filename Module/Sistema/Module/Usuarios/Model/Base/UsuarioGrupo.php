 ...
 */
abstract class Model_Base_UsuarioGrupo extends \Model_App
{
    ...
    {
        $fkClass = Model_UsuarioGrupo::$fkNamespace['Model_Usuario'].'\Model_Usuario';
        $Usuario = new $fkClass($this->usuario);
        if ($Usuario->exists()) {
            return $Usuario;
        }
        return null;
    ...
    {
        $fkClass = Model_UsuarioGrupo::$fkNamespace['Model_Grupo'].'\Model_Grupo';
        $Grupo = new $fkClass($this->grupo);
        if ($Grupo->exists()) {
            return $Grupo;
        }
        return null;
