...
foreach ($Usuarios as &$obj) {
    ...
    $row[] =
        ...
        '<a href="'.$_base.$module_url.$controller.'/eliminar/'.urlencode($obj->id).'" title="Eliminar" onclick="return eliminar(\'Usuario\', \''.$obj->id.'\')"><img src="'.$_base.'/img/icons/16x16/actions/delete.png" alt="" /></a>';
    $data[] = $row;
}
