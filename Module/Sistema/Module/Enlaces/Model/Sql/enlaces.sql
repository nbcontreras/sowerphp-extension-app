...
CREATE TABLE enlace_categoria (
    ...
    madre INTEGER,
    CONSTRAINT enlace_categoria_madre_fkey FOREIGN KEY (madre) REFERENCES enlace_categoria (id) MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE
);
CREATE INDEX ON enlace_categoria USING HASH (madre);
...
CREATE TABLE enlace (
    ...
    CONSTRAINT enlace_categoria_fkey FOREIGN KEY (categoria) REFERENCES enlace_categoria (id) MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE
);
CREATE INDEX ON enlace USING HASH (categoria);
